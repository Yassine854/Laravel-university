<x-app-layout>
    ...
    <x-jet-bar-container>
                ...
                <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            ...
                            <form action="{{ route('admin.departments.create') }}" method="put">
                                @csrf
                                @method('POST')
                                @if ($errors->any())
        ...
        <div>
            ...
            @if(session('success'))
            <x-jet-bar-alert type="success" text="Département ajouté avec succès !" />

            @endif

            @if(session('warning'))
            <x-jet-bar-alert type="warning" text="Département modifié avec succès !" />

            @endif


            @if(session('danger'))
            <x-jet-bar-alert type="danger" text="Département supprimé !" />
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <x-jet-bar-table-data>
                            <a href="#" class="text-gray-400 hover:text-gray-500">
                                ...
                                <div x-data="{ editModal: {{ $errors->any() &&  session('edit_department_id') == $department->id  &&  session('form_type') === 'edit'? 'true' : 'false' }}, editdepartmentId: {{ $department->id }} }">
                                    <!-- Button to open modal -->
                                    ...
                                    <div x-show="editModal" class="fixed z-10 inset-0 overflow-y-auto"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <!-- Modal Header -->
                                                <div class="bg-gray-100 px-4 py-3 sm:px-6">
                                                    <h3 class="text-lg font-medium text-gray-900">Modifier Département
                                                    </h3>
                                                </div>
                        ...
                        <x-jet-bar-table-data>
                            <a href="#" class="text-gray-400 hover:text-gray-500">
                                ...
                                <div x-data="{ deleteModal: false, departmentId: {{ $department->id }} }">
                                    ...
                                    <div x-show="deleteModal" class="fixed z-10 inset-0 overflow-y-auto"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                                    <form :action="'{{ route('admin.departments.destroy', '') }}/' + departmentId"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
