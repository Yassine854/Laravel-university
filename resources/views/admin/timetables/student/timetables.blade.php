                ...
                <template x-data="{ total:1 }"  x-for="index in total">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <x-jet-bar-table-data >
                            ...
                            <a href="{{ route('admin.timetables.downloadStudentsTimetable', ['fileName' => $timetable->file]) }}" target="_blank" class="inline-block bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600">Télécharger</a>
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <form action="{{ route('admin.timetables.updateStudentsTimetable', ['department' => $department,'field' => $field,'id'=>$timetable->id]) }}" method="POST">
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            <button type="submit" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:ml-3 sm:w-auto sm:text-sm">Ajouter</button>
